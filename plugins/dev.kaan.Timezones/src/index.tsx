...
const getAllTimezones = () =>
  Intl.supportedValuesOf("timeZone").map((timezone) => ({
    label: `${timezone} (${new Intl.DateTimeFormat(undefined, { timeZone: timezone, timeZoneName: "short" })
...
export function Settings() {
  return <>
    <SwitchItem note="Use Icon with tooltip instead of text" {...util.useSetting(owo, "icon", true)}>Show Icon</SwitchItem>
  </>
}
