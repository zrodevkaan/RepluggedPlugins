...
const classes: any = await webpack.waitForProps<{ iconItem: string }>("iconItem");
...
const SimpleProfile: any = webpack.getByProps('BiteSizeProfileHeader');
interface Data {
  user: object;
}
...
export function start() {
  ...
  if (SimpleProfile) {
    injector.after(SimpleProfile, "BiteSizeProfileHeader", (a, res, instance) => {
      const User = a?.[0]["user"];
